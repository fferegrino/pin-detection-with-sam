...
from web.sam import mask_predictor
...
original_image = cv2.cvtColor(cv2.imread("web/static/pins@high.jpg"), cv2.COLOR_BGR2RGB)
...
def get_index(request: Request):
    ...
    data = {"request": request, "image": img, "width": image_to_show.width, "height": image_to_show.height,
            "existing_cutouts": existing_cutouts, "ratio": ratio}
...
def post_cut(request: Request, box: BoundingBox):
    ...
    for mask in masks:
        ...
        metadata = {
            ...
            "original_bbox": {"x1": original_box[0], "y1": original_box[1], "x2": original_box[2], "y2": original_box[3]},
...
def post_select_cutout(request: Request,
